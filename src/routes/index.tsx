  ...
  return (
    <main>
      <section className="relative isolate min-h-[88svh] overflow-hidden bg-night text-ivory">
        <img src="/hero.jpg?v=2" alt="" className="absolute inset-0 size-full object-cover object-left opacity-55" />
        <div className="absolute inset-0 bg-linear-to-r from-night/55 via-night/40 to-night/75" />
